...
// Función para cargar cotizaciones pagadas
async function cargarCotizacionesPagadas() {
  ...
  try {
    ...
    // Filtrar cotizaciones pagadas (usando campo status en MongoDB)
    const cotizacionesPagadas = cotizacionesGuardadas.filter(c => c.status === 'pagada');
  ...
  cotizaciones.forEach(cotizacion => {
    ...
    card.innerHTML = `
      <div class="cotizacion-header">
        ...
        <div class="cotizacion-status status-pagada">
          Pagada
        </div>
      </div>
